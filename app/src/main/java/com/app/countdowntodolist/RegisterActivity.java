...
public class RegisterActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.app.countdowntodolist.R.layout.activity_register);

        mUsernameField = (EditText) findViewById(com.app.countdowntodolist.R.id.register_username);
        mPasswordField = (EditText) findViewById(com.app.countdowntodolist.R.id.register_password);
        mErrorField = (TextView) findViewById(com.app.countdowntodolist.R.id.error_messages);
    }
